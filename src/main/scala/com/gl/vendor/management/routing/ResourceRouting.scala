package com.gl.vendor.management.routing
...
import com.gl.vendor.management.serializers.JsonSupport

trait ResourceRouting extends Directives with JsonSupport {
